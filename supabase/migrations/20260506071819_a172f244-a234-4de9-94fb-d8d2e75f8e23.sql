...
BEGIN
  ...
  -- Permissions: super admin OR club owner/admin
  ...
  PERFORM public.log_audit_event('snapshot_category', 'category', _category_id, jsonb_build_object('snapshot_id', v_snapshot_id, 'version', v_version));
