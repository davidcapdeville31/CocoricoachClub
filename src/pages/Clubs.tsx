...
import logoCoq from "@/assets/logo-coq-transparent.png";
...
export default function Clubs() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      <div className="py-8 sm:py-16 px-4" style={{ background: "linear-gradient(135deg, hsl(8 85% 52%), hsl(8 80% 60%))" }}>
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex items-center justify-between gap-3 sm:gap-4 min-w-0">
            <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
              ...
              <p className="text-sm sm:text-lg text-white hidden sm:block">
          ...
          <p className="text-xs text-white mt-3 sm:hidden">
            Gestion des clubs et suivi des performances
          </p>
        </div>
      </div>
