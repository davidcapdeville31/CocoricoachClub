...
BEGIN
  ...
  -- Remove old category link entirely (player no longer belongs to source category)
  ...
  -- Remove old category_members link for athlete user account
  ...
  UPDATE public.player_match_stats SET category_id = _to_category_id WHERE player_id = _player_id AND category_id = _from_category_id;
