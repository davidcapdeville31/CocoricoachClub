      ...
      {(() => {
        ...
        return (
          <Tabs defaultValue="today" className="space-y-4">
            <TabsList className="bg-surface-sunken border-border/80 shadow-none">
              <TabsTrigger value="today" className="gap-2 bg-transparent data-[state=active]:bg-surface data-[state=active]:text-foreground data-[state=active]:shadow-sm">
                <ClipboardCheck className="h-4 w-4" />
                Aujourd'hui ({todaySessions.length})
              </TabsTrigger>
              <TabsTrigger value="upcoming" className="gap-2 bg-transparent data-[state=active]:bg-surface data-[state=active]:text-foreground data-[state=active]:shadow-sm">
                <Calendar className="h-4 w-4" />
                À venir ({upcomingSessions.length})
              </TabsTrigger>
              <TabsTrigger value="past" className="gap-2 bg-transparent data-[state=active]:bg-surface data-[state=active]:text-foreground data-[state=active]:shadow-sm">
                <Clock className="h-4 w-4" />
                Passées ({pastSessions.length})
              </TabsTrigger>
              <TabsTrigger value="players" className="gap-2 bg-transparent data-[state=active]:bg-surface data-[state=active]:text-foreground data-[state=active]:shadow-sm">
