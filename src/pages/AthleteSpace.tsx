...
export default function AthleteSpace() {
  ...
  if (showPlayerSelector) {
    return (
      <div className="min-h-screen bg-background">
        <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur pt-[env(safe-area-inset-top)]">
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* Header */}
      <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 pt-[env(safe-area-inset-top)]">
