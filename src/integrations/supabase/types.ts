...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      athlete_attributes: {
        Row: {
          created_at: string
          created_by: string | null
          dimension: Database["public"]["Enums"]["athlete_attribute_dimension"]
          id: string
          is_primary: boolean
          metadata: Json
          player_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "athlete_attributes_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "player_tags"
            referencedColumns: ["player_id"]
      ...
      periodization_cycle_players: {
        ...
        Relationships: [
          {
            foreignKeyName: "periodization_cycle_players_cycle_id_fkey"
            columns: ["cycle_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "periodization_cycle_players_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "player_tags"
            referencedColumns: ["player_id"]
      ...
      player_coaches: {
        ...
        Relationships: [
          {
            foreignKeyName: "player_coaches_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "player_coaches_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "player_tags"
            referencedColumns: ["player_id"]
      ...
      player_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "player_groups_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
      ...
      sports_config: {
        Row: {
          allowed_values: Json
          created_at: string
          default_primary_required: boolean
          dimension: Database["public"]["Enums"]["athlete_attribute_dimension"]
          display_order: number
          id: string
          metadata: Json
    ...
    Functions: {
      ...
      compute_age_category: {
        Args: { _birth_date: string; _ref_date?: string }
        Returns: string
      }
