...
const REGIONS: BodyRegion[] = [
  ...
  { id: "biceps_l", label: "Bras gauche (biceps)", zone: "Haut du corps", side: "front", cx: 33, cy: 31 },
  { id: "biceps_r", label: "Bras droit (biceps)", zone: "Haut du corps", side: "front", cx: 67, cy: 31 },
  { id: "abs", label: "Abdominaux", zone: "Abdomen", side: "front", cx: 50, cy: 42 },
  { id: "oblique_l", label: "Oblique gauche", zone: "Abdomen", side: "front", cx: 44, cy: 43 },
  { id: "oblique_r", label: "Oblique droit", zone: "Abdomen", side: "front", cx: 56, cy: 43 },
  { id: "elbow_l_f", label: "Coude gauche", zone: "Haut du corps", side: "front", cx: 31, cy: 40 },
  { id: "elbow_r_f", label: "Coude droit", zone: "Haut du corps", side: "front", cx: 69, cy: 40 },
  { id: "forearm_l", label: "Avant-bras gauche", zone: "Haut du corps", side: "front", cx: 30, cy: 46 },
  { id: "forearm_r", label: "Avant-bras droit", zone: "Haut du corps", side: "front", cx: 70, cy: 46 },
  { id: "wrist_l_f", label: "Poignet gauche", zone: "Haut du corps", side: "front", cx: 28, cy: 52 },
  { id: "wrist_r_f", label: "Poignet droit", zone: "Haut du corps", side: "front", cx: 72, cy: 52 },
  { id: "hand_l_f", label: "Main gauche", zone: "Haut du corps", side: "front", cx: 27, cy: 57 },
  { id: "hand_r_f", label: "Main droite", zone: "Haut du corps", side: "front", cx: 73, cy: 57 },
  ...
  { id: "triceps_l", label: "Bras gauche (triceps)", zone: "Haut du corps", side: "back", cx: 33, cy: 31 },
  { id: "triceps_r", label: "Bras droit (triceps)", zone: "Haut du corps", side: "back", cx: 67, cy: 31 },
  { id: "elbow_l_b", label: "Coude gauche", zone: "Haut du corps", side: "back", cx: 31, cy: 40 },
  { id: "elbow_r_b", label: "Coude droit", zone: "Haut du corps", side: "back", cx: 69, cy: 40 },
  { id: "forearm_l_b", label: "Avant-bras gauche", zone: "Haut du corps", side: "back", cx: 30, cy: 46 },
  { id: "forearm_r_b", label: "Avant-bras droit", zone: "Haut du corps", side: "back", cx: 70, cy: 46 },
  { id: "hand_l_b", label: "Main gauche", zone: "Haut du corps", side: "back", cx: 27, cy: 57 },
  { id: "hand_r_b", label: "Main droite", zone: "Haut du corps", side: "back", cx: 73, cy: 57 },
