              ...
              <SelectContent>
                ...
                <SelectItem value="coach">
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Peut ajouter et modifier les données</div>
                  </div>
                </SelectItem>
                <SelectItem value="admin">
                  <div>
                    <div className="font-medium">Admin</div>
                    <div className="text-xs text-muted-foreground">Gestion complète du club</div>
                  </div>
                </SelectItem>
              </SelectContent>
            </Select>
