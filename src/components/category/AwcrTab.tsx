    ...
    <Card className="bg-gradient-card shadow-md">
      <CardHeader>
        ...
        <div className="flex justify-between items-center">
          <div>
            <CardTitle>Suivi de charge — Adhérence &amp; ACWR</CardTitle>
      ...
      <CardContent>
        {awcrData && awcrData.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-muted-foreground mb-4">Aucune donnée de charge enregistrée</p>
            {!isViewer && (
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Adhérence (réel/prévu)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {awcrData?.map((entry) => (
            ...
            <div className="mt-4 p-4 bg-muted/30 rounded-lg space-y-2">
              <p className="text-sm text-muted-foreground">
                <strong>Adhérence</strong> = charge réalisée ÷ charge prévue (indicateur descriptif). Les seuils de risque 0,8 - 1,3 s'appliquent uniquement à l'<strong>ACWR</strong> (charge aiguë 7 j ÷ charge chronique 28 j), visible dans Disponibilité &amp; Alertes.
              </p>
              {gpsCount === 0 && (
