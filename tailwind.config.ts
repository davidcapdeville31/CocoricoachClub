    ...
    extend: {
      colors: {
        ...
        nav: {
          ...
          effectif: "hsl(var(--nav-effectif))",
          planification: "hsl(var(--nav-planification))",
          programmation: "hsl(var(--nav-programmation))",
          performance: "hsl(var(--nav-performance))",
          sante: "hsl(var(--nav-sante))",
          competition: "hsl(var(--nav-competition))",
          gps: "hsl(var(--nav-gps))",
          video: "hsl(var(--nav-video))",
          communication: "hsl(var(--nav-communication))",
