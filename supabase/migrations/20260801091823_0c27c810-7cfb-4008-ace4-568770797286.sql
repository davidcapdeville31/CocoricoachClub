DROP POLICY IF EXISTS "Club owners can upload category cover images" ON storage.objects;
DROP POLICY IF EXISTS "Club owners can update category cover images" ON storage.objects;
DROP POLICY IF EXISTS "Club owners can delete category cover images" ON storage.objects;
