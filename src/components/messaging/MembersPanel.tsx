...
import { Search, ChevronDown, Users2 } from "lucide-react";
...
export function MembersPanel({ categoryId, onOpenConversation }: MembersPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <Collapsible open={open} onOpenChange={setOpen} className="flex flex-col h-full">
        ...
        <CollapsibleContent className="flex-1 overflow-hidden flex flex-col data-[state=closed]:hidden">
          <div className="p-3 border-b">
