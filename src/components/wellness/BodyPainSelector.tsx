...
const REGIONS: BodyRegion[] = [
  ...
  { id: "elbow_l_f", label: "Coude droit", zone: "Haut du corps", side: "front", cx: 32, cy: 36 },
  { id: "elbow_r_f", label: "Coude gauche", zone: "Haut du corps", side: "front", cx: 68, cy: 36 },
  { id: "forearm_l", label: "Avant-bras droit", zone: "Haut du corps", side: "front", cx: 30, cy: 43 },
  { id: "forearm_r", label: "Avant-bras gauche", zone: "Haut du corps", side: "front", cx: 70, cy: 43 },
  { id: "wrist_l_f", label: "Poignet droit", zone: "Haut du corps", side: "front", cx: 29, cy: 49 },
  { id: "wrist_r_f", label: "Poignet gauche", zone: "Haut du corps", side: "front", cx: 71, cy: 49 },
  { id: "hand_l_f", label: "Main droite", zone: "Haut du corps", side: "front", cx: 26, cy: 57 },
  { id: "hand_r_f", label: "Main gauche", zone: "Haut du corps", side: "front", cx: 74, cy: 57 },
